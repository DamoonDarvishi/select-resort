    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="assets/img/blog/blog-1.jpg" class="d-block w-100 slide-img" alt="...">
                <div class="backdrop">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>First slide label</h5>
                        <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
                        <a href="?page=blog&item=details" class="btn btn-primary">interdum</a>
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                <img src="assets/img/blog/blog-2.jpg" class="d-block w-100 slide-img" alt="...">
                <div class="backdrop">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Second slide label</h5>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                        <a href="?page=blog&item=details" class="btn btn-primary">adipiscing</a>
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                <img src="assets/img/blog/blog-3.jpg" class="d-block w-100 slide-img" alt="...">
                <div class="backdrop">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Third slide label</h5>
                        <p>Praesent commodo cursus magna, vel scelerisque nisl consectetur.</p>
                        <a href="?page=blog&item=details" class="btn btn-primary">commodo</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <main id="main">
        ...
        <section id="about" class="about">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2><a href="?page=about">About Us</a></h2>
                </div>
        ...
        <section id="services" class="services">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2><a href="?page=services">Services</a></h2>
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                        <div class="icon-box">
                            ...
                            <h4><a href="?page=services&item=details">Lorem Ipsum</a></h4>
                            <p>Voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi ducimus qui
                                blanditiis</p>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in"
                        ...
                        <div class="icon-box">
                            ...
                            <h4><a href="?page=services&item=details">Sed ut perspici</a></h4>
                            <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore quas
                    ...
                    <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in"
                        ...
                        <div class="icon-box">
                            ...
                            <h4><a href="?page=services&item=details">Magni Dolores</a></h4>
                            <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia ducimus qui
                                blanditiis </p>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in"
                        ...
                        <div class="icon-box">
                            ...
                            <h4><a href="?page=services&item=details">Nemo Enim</a></h4>
                            <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis in culpa qui
                                officia</p>
                        </div>
                    </div>
        ...
        <section id="team" class="team section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2><a href="?page=features">Features</a></h2>
                    <p>Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum quidem. Sit
                        sint consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias
                        ea. Quia fugiat sit in iste officiis commodi quidem hic quas.</p>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="100">
                            <div class="pic"><i class="icofont-responsive icons"></i></div>
                            <div class="member-info">
                                <a href="?page=features&item=details">
                                    <h4>Fully Responsive</h4>
                                </a>
                                <p>Explicabo voluptatem mollitia et repellat qui dolorum quasi accusamus facilis cum
                                    velit</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 mt-4 mt-lg-0">
                        <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="200">
                            <div class="pic"><i class="icofont-leaf icons"></i></div>
                            <div class="member-info">
                                <a href="?page=features&item=details">
                                    <h4>Refreshing Design</h4>
                                </a>
                                <p>Aut maiores voluptates amet et quis praesentium qui senda para dolorum quasi
                                    accusamus</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 mt-4">
                        <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="300">
                            <div class="pic"><i class="icofont-bootstrap icons"></i></div>
                            <div class="member-info">
                                <a href="?page=features&item=details">
                                    <h4>Bootstrap 5</h4>
                                </a>
                                <p>Quisquam facilis cum velit laborum corrupti fuga rerum quia dolorum quasi accusamus
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 mt-4">
                        <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="400">
                            <div class="pic"><i class="icofont-font icons"></i></div>
                            <div class="member-info">
                                <a href="?page=features&item=details">
                                    <h4>Font awesome</h4>
                                </a>
                                <p>Dolorum tempora officiis odit laborum officiis et et accusamus dolorum quasi
                                    accusamus</p>
                            </div>
                        </div>
                    </div>
        ...
        <section id="portfolio" class="portfolio section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2><a href="?page=portfolio">Portfolio</a></h2>
                    <p>Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum quidem. Sit
                        sint consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias
                        ea. Quia fugiat sit in iste officiis commodi quidem hic quas.</p>
                </div>
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        ...
                        <div class="portfolio-info">
                            ...
                            <a href="?page=portfolio&item=details" class="details-link" title="More Details"><i
        ...
        <section id="pricing" class="pricing">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2><a href="?page=pricing">Pricing</a></h2>
                    <p>Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum quidem. Sit
                        sint consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias
                        ea. Quia fugiat sit in iste officiis commodi quidem hic quas.</p>
                </div>
        ...
        <section id="contact" class="contact">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2><a href="?page=contact">Contact Us</a></h2>
                    <p>Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum quidem. Sit
                        sint consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias
                        ea. Quia fugiat sit in iste officiis commodi quidem hic quas.</p>
                </div>
                    ...
                    <div class="col-lg-5 d-flex align-items-stretch">
                        <div class="info">
                            ...
                            <div class="email">
                                ...
                                <h4>Email:</h4>
                                <p>apply@UKStudy.com</p>
                            </div>

                            <div class="phone">
                                <i class="icofont-phone"></i>
                                <h4>Call:</h4>
                                <p>+44(0) 1273 76 47 16</p>
                            </div>
