            ...
            <div class="col-lg-8 entries">
                ...
                <article class="entry">
                    ...
                    <h2 class="entry-title">
                        <a href="?page=blog&item=details">Dolorum optio tempore voluptas dignissimos cumque fuga qui
                            quibusdam quia</a>
                    </h2>

                    <div class="entry-meta">
                        <ul>
                            <li class="d-flex align-items-center"><i class="icofont-user"></i> <a href="#">John Doe</a>
                            </li>
                    ...
                    <div class="entry-content">
                        ...
                        <div class="read-more">
                            <a href="?page=blog&item=details">Read More</a>
                        </div>
                    </div>
                ...
                <article class="entry">
                    ...
                    <h2 class="entry-title">
                        <a href="?page=blog&item=details">Nisi magni odit consequatur autem nulla dolorem</a>
                    </h2>
                ...
                <article class="entry">
                    ...
                    <h2 class="entry-title">
                        <a href="?page=blog&item=details">Possimus soluta ut id suscipit ea ut. In quo quia et soluta
                            libero
                            sit sint.</a>
                    </h2>
                ...
                <article class="entry">
                    ...
                    <h2 class="entry-title">
                        <a href="?page=blog&item=details">Non rem rerum nam cum quo minus. Dolor distinctio deleniti
                    ...
                    <div class="entry-content">
                        <p>
                            ...
                            occaecati et quaerat magni itaque nam voluptas. Voluptatem ducimus sint id earum ut
                ...
                <div class="sidebar">
                    ...
                    <div class="sidebar-item recent-posts">
                        <div class="post-item clearfix">
                            ...
                            <h4><a href="?page=blog&item=details">Nihil blanditiis at in nihil autem</a></h4>
                            <time datetime="2020-01-01">Jan 1, 2020</time>
                        </div>

                        <div class="post-item clearfix">
                            <img src="assets/img/blog/blog-recent-2.jpg" alt="">
                            <h4><a href="?page=blog&item=details">Quidem autem et impedit</a></h4>
                            <time datetime="2020-01-01">Jan 1, 2020</time>
                        </div>

                        <div class="post-item clearfix">
                            <img src="assets/img/blog/blog-recent-3.jpg" alt="">
                            <h4><a href="?page=blog&item=details">Id quia et et ut maxime similique occaecati ut</a>
                            </h4>
                            <time datetime="2020-01-01">Jan 1, 2020</time>
                        </div>
                        ...
                        <div class="post-item clearfix">
                            ...
                            <h4><a href="?page=blog&item=details">Laborum corporis quo dara net para</a></h4>
                            <time datetime="2020-01-01">Jan 1, 2020</time>
                        </div>

                        <div class="post-item clearfix">
                            <img src="assets/img/blog/blog-recent-5.jpg" alt="">
                            <h4><a href="?page=blog&item=details">Et dolores corrupti quae illo quod dolor</a></h4>
                            <time datetime="2020-01-01">Jan 1, 2020</time>
                        </div>
